...
uni_subjects:
  - אלגברה
---
[[תואר/מספרים מרוכבים#הצגה טריגונומטרית]]
# הגדרה
## הצגה קרטזית`
...
$$
z^n=(re^{i\theta})^n=r^n(e^{i\theta})^n=re^{i n \theta}
$$
דוגמא:
...
[[תואר/מספרים מרוכבים#שורשים של מספרים מרוכבים\|שורשים של מספרים מרוכבים]]
דוגמא: $\sqrt[3]{ 1 }=1$
באופן כללי לשורש n-י יש n פתרונות
$-1=e^{i\pi}$
אפשר לעשות גם
$-1=\left( e^{ i\frac{\pi}{3} } \right)^{3}$
ואז לפי [[תואר/מספרים מרוכבים#משפט דה-מואבר]] $\sqrt[3]{ -1 }=e^{ i\frac{\pi}{3} }$
אפשר גם לעשות
$\left( e^{ i\frac{5\pi}{3} } \right)^{3}=-1$
ושוב [[תואר/מספרים מרוכבים#משפט דה-מואבר]] שמביא לנו $\sqrt[3]{  -1}=e^{ i\frac{5\pi}{3} }=e^{ -i\frac{\pi}{3} }$
או בקיצור
$$
\begin{gather}
z_{0}=-1 \\
